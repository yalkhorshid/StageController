function out = RWGs
%RWGS Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, RWGS.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, RWGs, at the MATLAB command prompt.
%   
%   The code file, RWGS.M and its associated MAT-file, RWGS.MAT (if
...
try
    MATvar = load('E:\lectures\MSC PROJECT\Matlab\RWGs');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in E:\lectures\MSC PROJECT\Matlab\RWGs.mat.
if (MATLoaded)
...
set(vidObj2, 'FramesPerTrigger', Inf);
